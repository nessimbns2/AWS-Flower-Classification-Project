...
parser.add_argument ('--arch', help = 'Vgg13 if this argument specified, otherwise Alexnet', type = str)
parser.add_argument ('--lrn', help = 'Learning rate, default= 0.001', type = float)
parser.add_argument ('--hidden_units', help = 'Hidden units in Classifier. Default= 2048', type = int)
